...
class ArchivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post archivos_url, params: { archivo: { descripción: @archivo.descripción, imagenes: @archivo.imagenes, titulo: @archivo.titulo } }
    end
  ...
  test "should update archivo" do
    patch archivo_url(@archivo), params: { archivo: { descripción: @archivo.descripción, imagenes: @archivo.imagenes, titulo: @archivo.titulo } }
